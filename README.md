# SAMPLE RESTFUL APIS 🛠️

Welcome to the Sample RESTful APIs repository! This Spring Boot-based application is designed for managing data collections, featuring comprehensive CRUD operations and admin functionalities for streamlined management. Integrated with MySQL and secured with JWT authentication, it ensures secure and efficient data handling. This API is ideal for developers who want to test their applications, work with a reliable backend, and learn how to integrate it into front-end applications.
